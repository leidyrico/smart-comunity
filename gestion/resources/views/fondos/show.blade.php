                        ...
                        <div class="p-6 text-gray-900">
                            ...
                            <form action="{{ route('fondos.ingreso', $fondo) }}" method="POST" class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="fecha" id="ingreso_fecha" value="{{ date('Y-m-d') }}" lang="es-VE" placeholder="dd/MM/yyyy" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                <div>
                        ...
                        <div class="p-6 text-gray-900">
                            ...
                            <form action="{{ route('fondos.egreso', $fondo) }}" method="POST" class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="fecha" id="egreso_fecha" value="{{ date('Y-m-d') }}" lang="es-VE" placeholder="dd/MM/yyyy" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                <div>
