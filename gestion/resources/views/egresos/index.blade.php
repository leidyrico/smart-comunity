        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if (session('success'))
                <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-4">
                    ...
                    @if (session('show_pdf_link') && session('egreso_id'))
                        <div class="mt-3 pt-3 border-t border-green-300">
                            <p class="text-sm font-medium mb-2">¿Deseas generar el PDF del egreso?</p>
                            <a href="{{ route('egresos.pdf', session('egreso_id')) }}" 
                        ...
                        <form method="GET" action="{{ route('egresos.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" name="fecha_desde" id="fecha_desde" 
                                       ...
                                       lang="es-VE" placeholder="dd/MM/yyyy"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            </div>
