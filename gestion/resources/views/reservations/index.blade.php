                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex justify-end space-x-3">
                                                ...
                                                @php($user = Auth::user())
                                                @php($isPropietario = $user && method_exists($user, 'isUsuarioPropietario') && $user->isUsuarioPropietario())
                                                @php($esSuReserva = $isPropietario && $user->apartamento_id && $reservation->apartamento_id == $user->apartamento_id)

                                                @if($reservation->estado !== 'cancelada' && (!$isPropietario || $esSuReserva))
