                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="nombre" name="nombre" type="text" class="mt-1 block w-full" 
                                    :value="old('nombre')" required autofocus placeholder="Ej: Salón de fiesta" />
                            ...
                            <div>
                                ...
                                <textarea id="descripcion" name="descripcion" rows="4" 
                                    ...
                                    placeholder="Describe las características y servicios del espacio...">{{ old('descripcion') }}</textarea>
                            ...
                            <div>
                                ...
                                <x-text-input id="precio_por_dia" name="precio_por_dia" type="number" step="0.01" min="0"
                                    class="mt-1 block w-full" :value="old('precio_por_dia')" required 
                                    placeholder="0.00" />
